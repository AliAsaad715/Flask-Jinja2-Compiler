...
public class PythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DOT", "COMMA", "COLON", "EQEQ", "NOTEQ", "EQUAL", "PLUS", "OPEN_B", 
			"CLOSE_B", "LBRACK", "RBRACK", "LBRACE", "RBRACE", "FLOAT_VALUE", "INT_VALUE", 
			"STRING", "ID", "LINE_JOINING", "COMMENT", "NEWLINE", "WS"
		};
	}
